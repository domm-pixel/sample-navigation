...
class CustomTextOutlineView : AppCompatTextView {
    ...
    private fun initView(context: Context, attrs: AttributeSet?) {
        ...
        stroke = type.getBoolean(R.styleable.CustomTextOutlineView_textStroke, false) // 아웃라인 유무
        strokeWidth =
            type.getFloat(R.styleable.CustomTextOutlineView_textStrokeWidth, 0.0f) // 아웃라인 두께
        strokeColor =
            type.getColor(R.styleable.CustomTextOutlineView_textStrokeColor, -0x1) // 아웃라인 컬러
    }
