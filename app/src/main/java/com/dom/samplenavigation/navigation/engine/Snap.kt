 ...
 * should be provided.
 *
 * The [MapLibreNavigation] uses a [SnapToRoute] by default. If you would like to customize the camera position,
 * create a concrete implementation of this class or subclass [SnapToRoute] and set it on [MapLibreNavigation].
 */
abstract class Snap {
    /**
